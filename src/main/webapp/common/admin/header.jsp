...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div class="d-flex justify-content-between bg-dark text-white rounded">
		...
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			<div class="navbar-nav">
				<a class="nav-item nav-link active text-white"
					href="<c:url value='/admin/blog' />">Manager Blog</a> <a
					class="nav-item nav-link text-white"
					href="<c:url value='/admin/comment' />">Manager Comment</a>
			</div>
		</div>
	</nav>
